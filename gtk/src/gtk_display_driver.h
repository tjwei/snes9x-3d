...
class S9xDisplayDriver
{
    public:
        ...
        virtual uint16 *get_next_buffer1 (void) = 0;
        virtual uint16 *get_current_buffer1 (void) = 0;
        virtual void push_buffer (uint16 *src1, uint16 *src2) = 0;
        virtual uint16 *get_next_buffer2 (void) = 0;
        virtual uint16 *get_current_buffer2 (void) = 0;
    ...
    protected:
        ...
        void         *padded_buffer1[4];
        void         *buffer1[4];
        void         *padded_buffer2[4];
        void         *buffer2[4];
};
