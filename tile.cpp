...
#define DRAW_PIXEL(N, M) {\
	if ( (Offset+N >= _D) && Z1 > GFX.DB1[Offset + N-_D] && (M)) \
	{ \
		GFX.S1[Offset + N - _D] = MATH(GFX.ScreenColors[Pix], GFX.SubScreen1[Offset + N -_D], GFX.SubZBuffer1[Offset + N -_D]); \
		GFX.DB1[Offset + N -_D] = Z2; \
	}\
    if (Z1 > GFX.DB2[Offset + _D+N] && (M)) \
	{ \
		GFX.S2[Offset + _D+N] = MATH(GFX.ScreenColors[Pix], GFX.SubScreen2[Offset + _D+N], GFX.SubZBuffer2[Offset + _D+N]); \
		GFX.DB2[Offset + _D+N] = Z2; \
	}}
...
#define DRAW_PIXEL_N2x1(N, M) {\
	if ((Offset+2*N >= _D) && Z1 > GFX.DB1[Offset + 2 * N-_D] && (M)) \
	{ \
        GFX.S1[Offset + 2 * N-_D] = GFX.S1[Offset + 2 * N + 1-_D] = MATH(GFX.ScreenColors[Pix], GFX.SubScreen1[Offset + 2 * N-_D], GFX.SubZBuffer1[Offset + 2 * N-_D]); \
		GFX.DB1[Offset + 2 * N-_D] = GFX.DB1[Offset + 2 * N + 1-_D] = Z2; \
	}\
    if (Z1 > GFX.DB2[Offset + 2 *N + _D] && (M)) \
	{ \
        GFX.S2[Offset + 2 * N + _D] = GFX.S2[Offset + 2 *N + _D+1] = MATH(GFX.ScreenColors[Pix], GFX.SubScreen2[Offset + 2 * N+ _D], GFX.SubZBuffer2[Offset + 2 *N+_D]); \
		GFX.DB2[Offset + 2 * N + _D] = GFX.DB2[Offset + 2 *N+ _D + 1] = Z2; \
	}}
...
#define DRAW_PIXEL_H2x1(N, M) {\
	if ((Offset+2*N >= _D) && Z1 > GFX.DB1[Offset + 2 * N-_D] && (M)) \
	{ \
		GFX.S1[Offset + 2 * N-_D] = MATH((GFX.ClipColors ? 0 : GFX.SubScreen1[Offset + 2 * N-_D]), GFX.RealScreenColors[Pix], GFX.SubZBuffer1[Offset + 2 * N-_D]); \
		GFX.S1[Offset + 2 * N + 1-_D] = MATH(GFX.ScreenColors[Pix], GFX.SubScreen1[Offset + 2 * N-_D], GFX.SubZBuffer1[Offset + 2 * N-_D]); \
		GFX.DB1[Offset + 2 * N-_D] = GFX.DB1[Offset + 2 * N + 1-_D] = Z2; \
	}\
    if (Z1 > GFX.DB2[Offset + 2 *N+ _D] && (M)) \
	{ \
        GFX.S2[Offset + 2 * N+_D] = MATH((GFX.ClipColors ? 0 : GFX.SubScreen2[Offset + 2 * N+_D]), GFX.RealScreenColors[Pix], GFX.SubZBuffer2[Offset + 2 * N+_D]); \
		GFX.S2[Offset + 2 * N+ _D + 1] = MATH(GFX.ScreenColors[Pix], GFX.SubScreen2[Offset + 2 * N+ _D], GFX.SubZBuffer2[Offset + 2 * N+ _D]); \
		GFX.DB2[Offset + 2 * N+ _D] = GFX.DB2[Offset + 2 *N+ _D + 1] = Z2; \
	}}
